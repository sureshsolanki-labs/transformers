...
Foundation model library — reference for VLM/LLM benchmarks, tokenizers, model loading, and adapter patterns across the ai-research collection.

## Planned adaptation notes

Use for reproducibility of VLM/LLM claims we cite; not part of the chamelion-agent production runtime.
